...
const EditMember: React.FC = () => {
 ...
 readOnly
 className="w-full px-4 py-2.5 bg-appBg border border-slate-900 rounded-xl text-sm text-slate-500 cursor-not-allowed focus:outline-none"
 />
 </div>
