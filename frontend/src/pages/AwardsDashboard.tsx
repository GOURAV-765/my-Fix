...
const defaultNomineesList: Nominee[] = [
 ...
 <h1 className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-warning via-orange-400 to-ieeeBlue">
 Awards & Recognition
 </h1>
 ...
 className="bg-transparent border-none text-textPrimary focus:outline-none cursor-pointer"
 />
 </div>
 ...
 disabled={evaluating}
 className="bg-gradient-to-r from-warning to-orange-500 hover:from-warning hover:to-orange-600 text-slate-950 font-bold px-4 py-2 rounded-xl text-xs flex items-center gap-2 cursor-pointer shadow-[0_0_20px_rgba(245,158,11,0.2)] disabled:opacity-50"
 >
 {evaluating ? (
 ...
 ? 'text-ieeeBlue border-ieeeBlue'
 : 'text-textMuted border-transparent hover:text-textBody'
 }`}
 >
 ...
 <p className="text-sm text-textMuted">Loading achievements records...</p>
 </div>
 ) : (
 ...
 <TrendingUp className="h-5 w-5 text-ieeeBlue" />
 ...
 <div className="flex items-center gap-3">
 <div className="flex items-center justify-center h-8 w-8 rounded-lg bg-ieeeBlue/15 border border-ieeeBlue/20 text-ieeeBlue font-black text-sm">
 #{index + 1}
 </div>
 <div>
 ...
 <p className="text-xs text-ieeeBlue font-semibold">{nom.awardRule.name}</p>
 </div>
 </div>
 <div className="flex items-center gap-3">
 <div className="text-right">
 <span className="text-base font-black text-textPrimary">{nom.score}</span>
 ...
 className="bg-success hover:bg-success text-white text-[10px] font-bold px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
 >
 ...
 <p className="text-xs text-textMuted leading-normal bg-appBg/40 p-3 rounded-xl border border-slate-900/50">
 {nom.reason}
 </p>
 </div>
 ))}
 ...
 <span className="block font-mono text-[10px] text-ieeeBlue mt-1 bg-appBg p-2 rounded">
 ...
 <p className="text-xs text-ieeeBlue font-semibold">
 ...
 <div className="space-y-6">
 <h2 className="text-lg font-extrabold text-textPrimary flex items-center gap-2">
 <Settings className="h-5 w-5 text-ieeeBlue" />
 ...
 <div className="grid grid-cols-3 gap-3 bg-appBg/50 p-3 rounded-xl border border-slate-900">
 <div>
 <label className="block text-textMuted mb-1">Min Events</label>
 <input
 type="number"
 name="minEvents"
 ...
 <div>
 <label className="block text-textMuted mb-1">Min Hours</label>
 <input
 type="number"
 name="minVolHours"
 ...
 <div>
 <label className="block text-textMuted mb-1">Min Tasks</label>
 <input
 type="number"
 name="minTasks"
 ...
 <div className="grid grid-cols-3 gap-3 bg-appBg/50 p-3 rounded-xl border border-slate-900">
 <div>
 <label className="block text-textMuted mb-1">Event Weight</label>
 <input
 type="number"
 step="0.1"
 name="weightEvents"
 ...
 <div>
 <label className="block text-textMuted mb-1">Hour Weight</label>
 <input
 type="number"
 step="0.1"
 name="weightVolHrs"
 ...
 <div>
 <label className="block text-textMuted mb-1">Task Weight</label>
 <input
 type="number"
 step="0.1"
 name="weightTasks"
 ...
 <button
 type="submit"
 className="w-full bg-ieeeBlue hover:bg-ieeeBlue text-white font-bold py-2 rounded-xl transition-all cursor-pointer"
 >
 Save Config
 </button>
 </form>
