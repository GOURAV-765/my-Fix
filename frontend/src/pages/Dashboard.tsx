...
const Dashboard: React.FC = () => {
 ...
 {/* Welcome Hero Panel */}
 <div ref={heroRef} className="relative overflow-hidden rounded-xl border border-ieeeBlue/20 bg-cardBg p-6 md:p-8 shadow-2xl" style={{ opacity: 0 }}>
 {/* Animated Aurora Background */}
 <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
 <div className="aurora-orb aurora-orb-1" />
 <div className="aurora-orb aurora-orb-2" />
 <div className="aurora-orb aurora-orb-3" />
 <div className="absolute inset-0 bg-cardBg backdrop-blur-[1px]" />
 </div>
 ...
 <div className="hero-badge inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold rounded-full bg-ieeeBlue/10 text-ieeeBlue border border-ieeeBlue/20" style={{ opacity: 0 }}>
 <Sparkles size={12} className="animate-pulse-slow" />
 {user?.societyName || 'Greenwood'}
 </div>
 <SplitText text={"Hello, " + (user?.member?.firstName || "User") + "!"} delay={400} duration={0.6} className="text-2xl md:text-3xl font-extrabold font-serif text-textPrimary tracking-tight" />
 <p className="hero-desc text-sm md:text-base text-textMuted max-w-xl" style={{ opacity: 0 }}>
 Welcome to your Society Management Portal. You are logged in as a{' '}
 <span className="text-ieeeBlue font-medium">{user?.role?.name}</span>. Here is the latest overview of your society membership.
 </p>
 </div>
 ...
 <Link
 to="/members/add"
 className="hero-btn flex items-center gap-2 px-4 py-2.5 bg-ieeeBlue hover:bg-ieeeBlue hover:shadow-lg hover:shadow-ieeeBlue/25 text-white rounded-xl text-sm font-semibold shadow-lg shadow-ieeeBlue/20 transition-all duration-300 hover:-translate-y-0.5"
 style={{ opacity: 0 }}
 >
 <UserPlus size={16} />
 Add Member
 ...
 <div
 className="metric-card bg-cardBg shadow-sm p-5 rounded-xl hover:border-ieeeBlue/30 transition-all duration-300 group relative cursor-default"
 onMouseMove={handleCardMouse}
 onMouseLeave={handleCardLeave}
 style={{ transformStyle: 'preserve-3d' }}
 >
 <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-ieeeBlue/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
 <div className="relative flex items-start justify-between">
 <div>
 <p className="text-xs font-semibold text-textMuted uppercase tracking-wider">Total Members</p>
 <h3 className="text-3xl font-extrabold text-textPrimary mt-2">
 <AnimatedCounter value={totalCount} />
 </h3>
 </div>
 <div className="p-3 rounded-xl bg-ieeeBlue-soft text-ieeeBlue border border-ieeeBlue/20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
 <Users size={20} />
 </div>
 </div>
 <div className="relative flex items-center gap-1.5 mt-4 text-xs text-ieeeBlue">
 ...
 <div
 className="metric-card bg-cardBg shadow-sm p-5 rounded-xl hover:border-success/30 transition-all duration-300 group relative cursor-default"
 onMouseMove={handleCardMouse}
 onMouseLeave={handleCardLeave}
 style={{ transformStyle: 'preserve-3d' }}
 >
 <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-success/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
 <div className="relative flex items-start justify-between">
 <div>
 <p className="text-xs font-semibold text-textMuted uppercase tracking-wider">Active Status</p>
 <h3 className="text-3xl font-extrabold text-textPrimary mt-2">
 <AnimatedCounter value={activeCount} />
 </h3>
 </div>
 <div className="p-3 rounded-xl bg-success/10 text-success border border-success/20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
 <UserCheck size={20} />
 </div>
 </div>
 <div className="relative flex items-center gap-1.5 mt-4 text-xs text-success">
 ...
 <div
 className="metric-card bg-cardBg shadow-sm p-5 rounded-xl hover:border-error/30 transition-all duration-300 group relative cursor-default"
 onMouseMove={handleCardMouse}
 onMouseLeave={handleCardLeave}
 style={{ transformStyle: 'preserve-3d' }}
 >
 <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-error/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
 <div className="relative flex items-start justify-between">
 <div>
 <p className="text-xs font-semibold text-textMuted uppercase tracking-wider">Inactive Status</p>
 <h3 className="text-3xl font-extrabold text-textPrimary mt-2">
 <AnimatedCounter value={inactiveCount} />
 </h3>
 </div>
 <div className="p-3 rounded-xl bg-error/10 text-error border border-error/20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
 <UserX size={20} />
 </div>
 </div>
 <div className="relative flex items-center gap-1.5 mt-4 text-xs text-error">
 ...
 <div
 className="metric-card bg-cardBg shadow-sm p-5 rounded-xl hover:border-warning/30 transition-all duration-300 group relative cursor-default"
 onMouseMove={handleCardMouse}
 onMouseLeave={handleCardLeave}
 style={{ transformStyle: 'preserve-3d' }}
 >
 <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-warning/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
 <div className="relative flex items-start justify-between">
 <div>
 <p className="text-xs font-semibold text-textMuted uppercase tracking-wider">Management</p>
 <h3 className="text-3xl font-extrabold text-textPrimary mt-2">
 <AnimatedCounter value={coreTeamCount} />
 </h3>
 </div>
 <div className="p-3 rounded-xl bg-warning/10 text-warning border border-warning/20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
 <ShieldCheck size={20} />
 </div>
 </div>
 <div className="relative flex items-center gap-1.5 mt-4 text-xs text-warning">
 ...
 <Link to="/members" className="text-xs font-semibold text-ieeeBlue hover:text-ieeeBlue transition-colors hover:underline underline-offset-2">
 View All
 </Link>
 </div>
 ...
 <p className="text-sm text-textMuted py-6 text-center">No members found.</p>
 ) : (
 ...
 className="p-1.5 text-textMuted hover:text-ieeeBlue hover:bg-ieeeBlue/10 rounded-lg transition-all duration-200"
 title="View Profile"
 >
 <ArrowRight size={14} />
 </Link>
 ...
 <div>
 <p className="font-semibold text-textPrimary">My Profile</p>
 <p className="text-[10px] text-textMuted">View your assigned privileges</p>
 </div>
 </Link>
 ...
 <div>
 <p className="font-semibold text-textPrimary">Add Member Profile</p>
 <p className="text-[10px] text-textMuted">Register a new resident user</p>
 </div>
 </Link>
 )}
 </div>
 ...
 <span className="font-semibold text-textPrimary">{user?.societyName}</span>
 </div>
 <div className="flex justify-between items-center">
 <span>Access Level:</span>
 <span className="font-semibold text-ieeeBlue">{user?.role?.name}</span>
 </div>
 <div className="flex justify-between items-center">
 <span>Permissions Count:</span>
 <span className="font-semibold text-textPrimary">{user?.permissions.length || 0}</span>
 </div>
 </div>
 </div>
 </div>
