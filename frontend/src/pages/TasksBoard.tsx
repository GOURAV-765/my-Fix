...
const defaultTasksMembersList: Member[] = [
 ...
 const columns = [
 { id: 'todo' as const, title: 'To Do', colorClass: 'bg-ieeeBlue/10 text-ieeeBlue border-ieeeBlue/20' },
 { id: 'in_progress' as const, title: 'In Progress', colorClass: 'bg-warning/10 text-warning border-warning/20' },
 { id: 'completed' as const, title: 'Completed', colorClass: 'bg-success/10 text-success border-success/20' },
 ];
 ...
 <p className="text-sm text-textMuted">Loading Kanban board...</p>
 </div>
 ) : (
 ...
 <div
 key={col.id}
 className="bg-cardBg shadow-sm p-4 rounded-xl border border-slate-850 bg-appBg/20 flex flex-col gap-4 min-h-[500px]"
 >
 ...
 className="text-slate-500 hover:text-ieeeBlue p-0.5 transition-colors cursor-pointer"
 title="Edit Task"
 >
 ...
 className="text-slate-500 hover:text-error p-0.5 transition-colors cursor-pointer"
 title="Delete Task"
 >
 ...
 <h4 className="font-extrabold text-textPrimary text-xs leading-normal">
 {task.title}
 </h4>
