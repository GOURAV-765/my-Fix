...
const defaultMembersAttendanceList: Member[] = [
 ...
 <h1 className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-success via-teal-400 to-cyan-400">
 Attendance Logger
 </h1>
 ...
 className="bg-ieeeBlue/20 hover:bg-ieeeBlue/30 text-ieeeBlue border border-ieeeBlue/25 px-4 py-2.5 rounded-xl text-xs font-bold flex items-center gap-1.5 cursor-pointer"
 >
 ...
 <p className="text-sm text-textMuted">Loading attendance module...</p>
 </div>
 ) : (
 <>
 {/* Control Bar */}
 ...
 <span className="text-3xl font-extrabold text-textPrimary">{attendanceRate}%</span>
 <span className="text-xs text-slate-500">of logged members</span>
 </div>
 <div className="h-1.5 w-full bg-cardBg rounded-full overflow-hidden">
 <div
 ...
 <span className="text-3xl font-extrabold text-textPrimary">{presentCount}</span>
 </div>
 <div className="p-2.5 rounded-xl bg-success/40 text-success border border-success/30">
 ...
 <span className="text-3xl font-extrabold text-textPrimary">{absentCount}</span>
 </div>
 <div className="p-2.5 rounded-xl bg-error/40 text-error border border-error/30">
 ...
 <div className="col-span-full bg-cardBg shadow-sm p-20 rounded-xl border border-slate-850 text-center">
 ...
 <div
 key={member.id}
 className={`bg-cardBg shadow-sm p-5 rounded-xl border transition-all duration-300 relative flex flex-col justify-between gap-5 ${
 status === 'present'
 ...
 <div>
 <label className="block text-textMuted mb-1">Meeting Title</label>
 <input
 type="text"
 required
 {...register('title')}
 ...
 <div>
 <label className="block text-textMuted mb-1">Meeting Date</label>
 <input
 type="date"
 required
 {...register('date')}
 ...
 <div>
 <label className="block text-textMuted mb-1">Agenda / Description</label>
 <textarea
 ...
 <button
 type="submit"
 className="w-full bg-ieeeBlue hover:bg-ieeeBlue text-white font-bold py-2.5 rounded-xl cursor-pointer"
 >
